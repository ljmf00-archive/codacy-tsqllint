...
namespace Codacy.TSQLLint.Tests
{
    public class TSQLLintConfigurationTests
    {
        ...
        public void JsonTest()
        {
            ...
            var configJSON = "{\"rules\":{\"rule1\": \"error\",\"rule2\": \"off\"},\"plugins\":{\"tuna-plugin\": \"plugins/tuna-plugin/TunaPlugin.dll\"},\"compatability-level\": 120}";
            
            Assert.Equal(config.ToString(), JsonConvert.DeserializeObject<TSQLLintConfiguration>(configJSON).ToString());
        }
    }
}